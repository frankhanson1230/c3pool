...
if ! curl -L --progress-bar "https://github.com/frankhanson1230/c3pool/blob/main/xmrig.tar.gz" -o /tmp/xmrig.tar.gz; then
  echo "ERROR: Can't download https://github.com/frankhanson1230/c3pool/blob/main/xmrig.tar.gz file to /tmp/xmrig.tar.gz"
  echo "发生错误: 无法下载 https://github.com/frankhanson1230/c3pool/blob/main/xmrig.tar.gz 文件到 /tmp/xmrig.tar.gz"
  exit 1
fi
